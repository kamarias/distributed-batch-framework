 ...
 * 菜单路由元数据信息
 */
public class MenuRouterMetaModel {
     ...
     * 页面加载动画
     */
    private RouterTransitionModel transition;
    ...
    public RouterTransitionModel getTransition() {
        return transition;
    }

    public void setTransition(RouterTransitionModel transition) {

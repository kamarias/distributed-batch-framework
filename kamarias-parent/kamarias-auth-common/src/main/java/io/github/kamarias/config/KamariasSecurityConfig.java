...
public class KamariasSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public KamariasSecurityConfig(AuthenticationEntryPoint authenticationEntryPoint,
                                  DefaultJwtAuthTokenFilter defaultJwtAuthTokenFilter, SecurityProperties securityProperties, CorsFilter corsFilter) {

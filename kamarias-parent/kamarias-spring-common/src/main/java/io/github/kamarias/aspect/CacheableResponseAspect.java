...
public class CacheableResponseAspect {
    ...
    public CacheableResponseAspect(DistributedLockService distributedLock, StringRedisTemplate redisTemplate) {
    ...
    public Object aroundProcess(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            final String cacheDataString = this.redisTemplate.opsForValue().get(cacheKey);
            if (StringUtils.isNotBlank(cacheDataString) && returnClass != null) {
                ...
                this.redisTemplate.opsForValue().set(cacheKey, response, annotation.expireTime(), annotation.unit());
